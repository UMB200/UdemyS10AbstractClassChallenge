...
public class Main {
    public static void main(String[] args) {
        //UdemyLinkList udemyLinkList = new UdemyLinkList(null);
        UdemySearchTree searchTree = new UdemySearchTree(null);
        //udemyLinkList.traverse(udemyLinkList.getRoot());
        // Create a string data array to avoid typing loads of addItem instructions:
        String stringData = "Darwin Brisbane Perth Melbourne Canberra Adelaide Sydney Canberra";
        String stringDataNumbers = "5 2 1 4 5 6 7 8 9 100";
        // create new item with value set to the string s
        String[] data = stringDataNumbers.split(" ");
        for (String s : data) {
            searchTree.addItem(new UdemyNode(s));
        }
        //searchTree.traverse(searchTree.getRoot());
        searchTree.removeItem(new UdemyNode("5"));
        searchTree.traverse(searchTree.getRoot());
